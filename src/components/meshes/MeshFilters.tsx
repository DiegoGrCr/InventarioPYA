...
export default function MeshFilters({ brands, sizes, currentFilters }: MeshFiltersProps) {
  ...
  const setFilter = (key: string, value: string) => {
    ...
    params.delete('page')
    router.replace(`/mallas?${params.toString()}`)
  }

  const clearFilters = () => router.replace('/mallas')
